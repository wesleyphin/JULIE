...
function FilterlessLiveCockpit() {
  ...
  // Mobile detection — used to avoid the iOS Safari embedded-PDF glitch on
  // the README screen and to swap any layouts that need a JS-side branch.
    ...
    <section className="screen">
      ...
      >
        <div className="panel-body docs-panel-body">
          ...
          {isPhone ? (
            // Phone-only call-to-action — iOS Safari renders embedded PDFs
            // unreliably (the inline <object> shows as a black/grey frame),
            // so we render a dedicated card and skip <object> entirely on
            // phone. The inline viewer below only mounts on desktop.
            <div className="docs-viewer-mobile">
              ...
              <div className="docs-mobile-hint">
                Inline preview is desktop-only — phones open the PDF in a new tab where iOS uses its native viewer.
              </div>
            </div>
          ) : (
