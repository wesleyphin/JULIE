...
def _rule_seed_payload(
    ...
    payload = {
        ...
        "group_signal_policies": copy.deepcopy(candidate_seed_artifact.payload.get("group_signal_policies", {}) or {}),
        "group_policy_priority": str(candidate_seed_artifact.payload.get("group_policy_priority", "fill_only") or "fill_only"),
        ...
        "default_unlisted_policy": str(candidate_seed_artifact.payload.get("default_unlisted_policy", "") or ""),
