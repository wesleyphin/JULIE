...
5. loads strategy engines and artifacts
...
4. asks each active strategy whether it has a candidate
5. evaluates candidate priority
6. sends valid candidates to execution
